...
// 	userData := database_yaml.GetIDInfo(&opts.Update.Message.From.ID)
// 	if userData == nil && database_yaml.AddUserInfo(opts.Update.Message.From) {
// 		log.Printf("add (saveMessage)private \"%s\"(%s)[%d] in consts.Database",
// 			utils.ShowUserName(opts.Update.Message.From), opts.Update.Message.From.Username, opts.Update.Message.From.ID,
// 		)
// 		userData = database_yaml.GetIDInfo(&opts.Update.Message.From.ID)
// 	}
// 	SavedMessage := consts.Database.Data.SavedMessage[userData.ID]
...
// 			consts.Database.Data.SavedMessage[userData.ID] = SavedMessage
// 			signals.SignalsChannel.Database_save <- true
...
// var SavedMessage_SlashSymbolCommandHandler = plugin_utils.Plugin_SlashSymbolCommand{
// 	SlashCommand: "save",
...
// 	SavedMessage := consts.Database.Data.SavedMessage[opts.ChatInfo.ID]
...
// var SavedMessage_InlineCommandHandler = plugin_utils.Plugin_Inline{
// 	Command: "saved",
...
// 		if len(database_yaml.Database.Data.SavedMessage) == 0 {
// 			consts.Database.Data.SavedMessage = make(map[int64]SavedMessage)
...
// var SavedMessage_StartCommandHandlers = []plugin_utils.SlashStartHandler{
// 	{
...
// var SavedMessage_StartCommandWithPrefixHandlers = []plugin_utils.SlashStartWithPrefixHandler{
// 	{
// 		Prefix:   "via-inline",
// 		Argument: "noreply",
// 		Handler:  nil,
